...
#[sea_orm(table_name = "qobuz_album_tracks")]
pub struct Model {
    #[sea_orm(primary_key)]
    pub id: Uuid,
    pub album_id: Uuid,
...
pub enum Relation {
    #[sea_orm(belongs_to = "super::qobuz_album::Entity", from = "Column::AlbumId", to = "super::qobuz_album::Column::Id")]
    Album,
    #[sea_orm(belongs_to = "super::qobuz_track::Entity", from = "Column::TrackId", to = "super::qobuz_track::Column::Id")]
    Track,
}

impl Related<super::qobuz_album::Entity> for Entity { fn to() -> RelationDef { Relation::Album.def() } }
