...
#[sea_orm(table_name = "server_playlist_tracks")]
pub struct Model {
    #[sea_orm(primary_key)]
    pub id: Uuid,
...
pub enum Relation {
    #[sea_orm(belongs_to = "super::server_playlist::Entity", from = "Column::PlaylistId", to = "super::server_playlist::Column::Id")]
    Playlist,
    #[sea_orm(belongs_to = "super::server_track::Entity", from = "Column::TrackId", to = "super::server_track::Column::Id")]
    Track,
}

impl Related<super::server_playlist::Entity> for Entity { fn to() -> RelationDef { Relation::Playlist.def() } }
