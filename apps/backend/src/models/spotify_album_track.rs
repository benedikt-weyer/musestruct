...
#[sea_orm(table_name = "spotify_album_tracks")]
pub struct Model {
    #[sea_orm(primary_key)]
    pub id: Uuid,
    pub album_id: Uuid,
...
pub enum Relation {
    #[sea_orm(belongs_to = "super::spotify_album::Entity", from = "Column::AlbumId", to = "super::spotify_album::Column::Id")]
    Album,
    #[sea_orm(belongs_to = "super::spotify_track::Entity", from = "Column::TrackId", to = "super::spotify_track::Column::Id")]
    Track,
}

impl Related<super::spotify_album::Entity> for Entity { fn to() -> RelationDef { Relation::Album.def() } }
